...
android {
    namespace = "com.matlav.flutter_ecom"
    ...
    defaultConfig {
        // Application ID unique pour le Play Store
        applicationId = "com.matlav.flutter_ecom"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        minSdk = 23  // Requis pour Firebase Auth 23.2.1
